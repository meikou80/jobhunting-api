...
type JobRepository interface {
	...
	GetByCompanyName(ctx context.Context, companyName string) ([]*models.Job, error)

	// 外部連携
	GetByExternalID(ctx context.Context, sourcePlatform, externalID string) (*models.Job, error)
